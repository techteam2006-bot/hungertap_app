...
/** Brand mark with black keyed out for light surfaces. */
const appLogoTransparent = require('../assets/logo-transparent.png');
/** Compact app icon (icon.png) — launcher / adaptive icon asset. */
const appIcon = require('../assets/icon.png');

export const APP_LOGO = appLogo;
export const APP_LOGO_TRANSPARENT = appLogoTransparent;
