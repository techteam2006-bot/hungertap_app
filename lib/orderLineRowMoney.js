...
/**
 * Bill header total: sum of line subtotals when possible, else `orders.total_amount` when &gt; 0
 * (covers delivered rows in `archieved_order_items` when column names don’t sum in app).
 */
