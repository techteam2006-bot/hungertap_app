...
export async function registerForPushNotificationsAsync(userId) {
  try {
    ...
    // Use update-or-insert instead of upsert to avoid depending on a specific
    // unique constraint definition in the DB.
    ...
    if (saveError) {
      console.log('Failed saving Expo push token to user_tokens.fcm_token', saveError);
      return { token: null, reason: 'save_failed' };
    }
