 ...
 * @returns {Promise<{ isOpen: boolean, statusKnownFromServer: boolean }|null>}
 */
...
/** @param {string} scopeId @param {boolean} isOpen */
export async function setCachedCanteenStatus(scopeId, isOpen) {
  if (!scopeId) return;
  await writeSnapshot(
